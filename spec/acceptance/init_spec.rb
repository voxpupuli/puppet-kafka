...
describe 'kafka' do
  ...
  describe 'kafka::init' do
    ...
    context 'with specific kafka version' do
      ...
      describe file('/opt/kafka-2.10-0.8.2.2') do
        it { is_expected.to be_directory }
        it { is_expected.to be_owned_by 'kafka' }
        it { is_expected.to be_grouped_into 'kafka' }
      end
      ...
      describe file('/opt/kafka') do
        it { is_expected.to be_linked_to('/opt/kafka-2.10-0.8.2.2') }
      end
    ...
    context 'with specific scala version' do
      ...
      describe file('/opt/kafka-2.11-0.8.2.1') do
        it { is_expected.to be_directory }
        it { is_expected.to be_owned_by 'kafka' }
        it { is_expected.to be_grouped_into 'kafka' }
      end
      ...
      describe file('/opt/kafka') do
        it { is_expected.to be_linked_to('/opt/kafka-2.11-0.8.2.1') }
      end
